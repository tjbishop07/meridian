...
export function registerTagHandlers() {
    ...
    ipcMain.handle('tags:update', async (_, data) => {
        try {
    ...
    ipcMain.handle('tags:get-monthly-stats', async (_, months) => {
        try {
    ...
    ipcMain.handle('tags:get-for-transaction', async (_, transactionId) => {
        try {
    ...
    ipcMain.handle('tags:set-for-transaction', async (_, transactionId, tagIds) => {
        try {
    ...
    ipcMain.handle('tags:get-transactions', async (_, tagId) => {
        try {
    ...
    ipcMain.handle('tags:auto-tag', async (event) => {
        try {
