...
export interface ElementIdentification {
  ...
  text?: string;              // Button text, link text, etc.
  ...
  // Context
  nearbyLabels?: string[];   // Labels near the element
  href?: string | null;      // Link destination (for validation)
  parentRole?: string;       // Parent element role
  parentClass?: string | null; // Parent element class

  // Visual properties (for validation)
  isVisible?: boolean;
  elementSize?: {
    width: number;
    height: number;
 ...
 */
export function generateElementIdentificationScript(elementSelector: string): string {
  return `
    (function() {
 ...
 */
export function generateElementFinderScript(identification: ElementIdentification): string {
  return `
    (function() {
 ...
 */
export function extractIdentification(step: any): ElementIdentification {
  // New format
