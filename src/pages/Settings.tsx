...
export default function Settings() {
  ...
  return (
    <div className="flex h-full">
      ...
      <div key={activeSection} className="flex-1 overflow-y-auto px-10 pt-8 pb-10">

        {activeSection === 'system' && <Section
          id="system"
        ...
        {activeSection === 'scraping' && <Section
          id="scraping"
        ...
        {activeSection === 'ai_models' && <Section
          id="ai_models"
        ...
        {activeSection === 'receipt_scanning' && <Section
          id="receipt_scanning"
