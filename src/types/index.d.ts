...
export interface DashboardData {
    ...
    upcomingBills: Array<Bill & {
        days_until_due: number;
    }>;
    budgetProgress: Array<Budget & {
        spent: number;
        remaining: number;
        percentage: number;
    }>;
    goalProgress: Array<Goal & {
        progress: number;
    }>;
...
export interface ElectronAPI {
    ...
    invoke(channel: 'accounts:update', data: Partial<Account> & {
        id: number;
    }): Promise<Account>;
    ...
    invoke(channel: 'categories:update', data: Partial<Category> & {
        id: number;
    }): Promise<Category>;
    ...
    invoke(channel: 'budgets:update', data: Partial<BudgetInput> & {
        id: number;
    }): Promise<Budget>;
    ...
    invoke(channel: 'goals:update', data: Partial<GoalInput> & {
        id: number;
    }): Promise<Goal>;
    invoke(channel: 'goals:delete', id: number): Promise<void>;
    invoke(channel: 'goals:add-contribution', data: {
        goal_id: number;
        amount: number;
        date?: string;
        notes?: string;
    ...
    invoke(channel: 'bills:update', data: Partial<BillInput> & {
        id: number;
    }): Promise<Bill>;
    invoke(channel: 'bills:delete', id: number): Promise<void>;
    invoke(channel: 'bills:record-payment', data: {
        bill_id: number;
        amount: number;
        date?: string;
    ...
    invoke(channel: 'import:preview', data: {
        filePath: string;
        accountId: number;
        format: CSVFormat;
    }): Promise<ImportPreview>;
    invoke(channel: 'import:execute', data: {
        accountId: number;
        rows: ParsedCSVRow[];
    ...
    invoke(channel: 'analytics:category-breakdown', data: {
        start_date: string;
        end_date: string;
        type: 'income' | 'expense';
    }): Promise<CategoryBreakdown[]>;
    invoke(channel: 'settings:get', key: string): Promise<string | null>;
    invoke(channel: 'settings:set', data: {
        key: string;
        value: string;
    }): Promise<void>;
    invoke(channel: 'settings:get-all'): Promise<Settings[]>;
    invoke(channel: 'dialog:open-file', options: {
        filters: Array<{
            name: string;
            extensions: string[];
        }>;
    }): Promise<string | null>;
    invoke(channel: 'browser:attach', url: string): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'browser:detach'): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'browser:show'): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'browser:hide'): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'browser:navigate', url: string): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'browser:back'): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'browser:forward'): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'browser:reload'): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'browser:start-recording'): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'browser:stop-recording'): Promise<{
        success: boolean;
        recording?: any;
    }>;
    invoke(channel: 'browser:execute-step', step: any): Promise<{
        success: boolean;
        error?: string;
    }>;
    invoke(channel: 'browser:prompt-sensitive-input', label: string, stepNumber: number, totalSteps: number): Promise<string>;
    invoke(channel: 'automation:start-recording', startUrl?: string, accountId?: number | null): Promise<{
        success: boolean;
    }>;
    invoke(channel: 'automation:save-recording', data: {
        name: string;
        institution: string | null;
        url: string;
        steps: string;
    ...
    invoke(channel: 'export-recipes:create', data: {
        name: string;
        institution: string | null;
        url: string;
        steps: string;
    ...
    invoke(channel: 'export-recipes:update', data: {
        id: string | number;
        name?: string;
        institution?: string | null;
        steps?: any[];
    ...
    invoke(channel: 'puppeteer:find-chrome'): Promise<{
        found: boolean;
        path?: string;
        error?: string;
    }>;
    invoke(channel: 'puppeteer:start-browser', options: {
        startUrl: string;
        chromePath?: string;
    ...
    invoke(channel: 'puppeteer:start-recording'): Promise<{
        success: boolean;
        url?: string;
        error?: string;
    }>;
    invoke(channel: 'puppeteer:stop-recording'): Promise<{
        success: boolean;
        steps?: any[];
        error?: string;
    }>;
    invoke(channel: 'puppeteer:execute-recipe', recipe: {
        steps: any[];
    ...
    invoke(channel: 'puppeteer:extract-transactions'): Promise<{
        success: boolean;
        transactions?: any[];
        count?: number;
        error?: string;
    }>;
    invoke(channel: 'puppeteer:close-browser'): Promise<{
        success: boolean;
        error?: string;
    }>;
    invoke(channel: 'ollama:check-status'): Promise<{
        installed: boolean;
        running: boolean;
    ...
    invoke(channel: 'ollama:check-homebrew'): Promise<{
        installed: boolean;
    }>;
    invoke(channel: 'ollama:open-homebrew-install'): Promise<void>;
    invoke(channel: 'ollama:install'): Promise<{
        success: boolean;
        error?: string;
    }>;
    invoke(channel: 'ollama:start-server'): Promise<{
        success: boolean;
        error?: string;
    }>;
    invoke(channel: 'ollama:pull-model', modelName: string): Promise<{
        success: boolean;
        error?: string;
    }>;
    invoke(channel: 'ollama:open-download-page'): Promise<void>;
    invoke(channel: 'ollama:generate', data: {
        model: string;
        prompt: string;
        stream?: boolean;
    }): Promise<{
    ...
    invoke(channel: 'tags:create', data: {
        name: string;
        color: string;
        description?: string;
    }): Promise<number>;
    invoke(channel: 'tags:update', data: {
        id: number;
        name?: string;
        color?: string;
        description?: string;
    ...
    invoke(channel: 'tags:auto-tag'): Promise<{
        tagged: number;
    }>;
    invoke(channel: 'tags:get-transactions', tagId: number): Promise<Transaction[]>;
    invoke(channel: 'tags:get-all-transaction-tags'): Promise<Array<{
        transaction_id: number;
        tag_id: number;
        tag_name: string;
        tag_color: string;
    }>>;
    invoke(channel: 'receipt:start-server'): Promise<{
        url: string;
        token: string;
    } | {
        error: string;
    ...
    invoke(channel: 'ai-scraper:check-model'): Promise<{
        installed: boolean;
    }>;
    invoke(channel: 'ai-scraper:open-browser', options: {
        accountId: number;
        startUrl: string;
    }): Promise<{
        success: boolean;
    ...
    invoke(channel: 'ai-scraper:execute', accountId: number): Promise<{
        success: boolean;
        transactions?: any[];
        error?: string;
    }>;
    invoke(channel: 'ai-scraper:execute-html', accountId: number): Promise<{
        success: boolean;
        transactions?: any[];
        error?: string;
    }>;
    invoke(channel: 'scraper:open-browser', options: {
        accountId: number;
        startUrl: string;
    }): Promise<{
        success: boolean;
    ...
    on(channel: 'csv:downloaded', callback: (data: {
        filePath: string;
        fileName: string;
    }) => void): void;
    ...
    on(channel: 'browser:error', callback: (error: {
        code: number;
        description: string;
        url: string;
    }) => void): void;
    ...
    on(channel: 'automation:scrape-complete', callback: (data: {
        recipeId: string;
        transactions: any[];
        count: number;
    }) => void): void;
    on(channel: 'scraper:transactions-found', callback: (data: {
        accountId: number;
        transactions: any[];
    }) => void): void;
    ...
    on(channel: 'tags:auto-tag-progress', callback: (data: {
        done: number;
        total: number;
    }) => void): void;
    on(channel: 'receipt:uploaded', callback: (data: {
        receiptId: number;
        extractedData: ReceiptData | null;
    }) => void): void;
    on(channel: 'receipt:analysis-progress', callback: (data: {
        step: string;
        imageDataUrl?: string;
    }) => void): void;
    on(channel: 'receipt:error', callback: (data: {
        message: string;
    }) => void): void;
