    ...
    <div className="space-y-6">
      <div className="bg-card rounded-lg p-6">
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-muted text-foreground rounded-lg hover:bg-muted/70 font-medium disabled:opacity-50 text-sm"
            >
        ...
        <div className="mb-6 p-4 bg-muted rounded-lg">
          <h4 className="font-semibold text-foreground mb-3">Ollama Status</h4>
        ...
        {/* Available Models */}
        <div>
          <h4 className="font-semibold text-foreground mb-3">Available Models</h4>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="font-medium text-foreground">{model.displayName}</h4>
                        {isInstalled && (
                      ...
                      <p className="text-xs text-muted-foreground mb-2">{model.purpose}</p>
                  ...
                  {isDownloading && (
                    <div className="mt-3">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs text-muted-foreground">{pullStatus}</span>
                        <span className="text-xs font-medium text-foreground">{pullPercentage}%</span>
                      </div>
        ...
        {ollamaStatus.availableModels.length > 0 && (
          <div className="mt-6 p-4 bg-muted rounded-lg">
            <h4 className="font-semibold text-foreground mb-2">Installed Models</h4>
            <div className="flex flex-wrap gap-2">
              {ollamaStatus.availableModels.map((model) => (
                <span
                  key={model}
                  className="px-3 py-1 text-xs font-medium bg-background text-foreground rounded-full border border-border"
                >
                  {model}
                </span>
              ))}
